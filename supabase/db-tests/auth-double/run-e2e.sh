...
for suite in e2e-autenticacao.mjs e2e-clientes.mjs e2e-produtos.mjs e2e-cadastros.mjs e2e-kits.mjs e2e-orcamentos.mjs e2e-pdf-compartilhamento.mjs e2e-empresa-usuarios.mjs e2e-relatorios.mjs; do
  echo "▶ semeando banco"
