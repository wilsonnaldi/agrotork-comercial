...
--   select * from brain.erp_events_faltando();
--   select brain.repor_eventos_erp();
--   commit;
--
-- É `brain.repor_eventos_erp()` que fecha o buraco do período desligado:
-- ele republica o estado atual de cada venda que ficou sem evento, e
