-- ============================================================
-- REMOVER O LOTE A DA FASE 2 (memória corporativa) — só sem dados
-- ============================================================
-- Caminho de volta do Lote A: desfaz as migrations 20260912010000 e
-- 20260912020000 e nada mais. A Fase 1 (CRM, eventos, pontes, cron) fica
...
-- ou vínculo. Conhecimento ingerido não é descartável por roteiro; se for
...
delete from supabase_migrations.schema_migrations
 where version in ('20260912010000', '20260912020000');
...
begin
  ...
  if exists (select 1 from supabase_migrations.schema_migrations where version in ('20260912010000','20260912020000')) then
