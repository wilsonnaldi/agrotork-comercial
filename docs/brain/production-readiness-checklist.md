...
| PR desta branch mergeado | NEEDS_WILSON | `hardening/brain-production-readiness`, 10 commits sobre `98a80b0` | abrir PR depois do PR #7; merge com `app-gates` e `brain-db-gate` verdes | Wilson |
