...
## FECHADO NESTA RODADA (26/09/2026 — revisão adversarial da production readiness)
...
3. **Observabilidade mínima dos outcomes** `[brain.synthesis]` em produção
   ...
   pergunta desde 26/09 (LOG1–LOG8b, OBS1–OBS14); falta contar com dado real
